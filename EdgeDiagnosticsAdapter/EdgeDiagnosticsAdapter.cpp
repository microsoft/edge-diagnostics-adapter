...
// Window Messages
LRESULT EdgeDiagnosticsAdapter::OnCopyData(UINT nMsg, WPARAM wParam, LPARAM lParam, _Inout_ BOOL& /*bHandled*/)
{
...
LRESULT EdgeDiagnosticsAdapter::OnMessageFromIE(UINT nMsg, WPARAM wParam, LPARAM lParam, _Inout_ BOOL& /*bHandled*/)
{
    CString message;
...
LRESULT EdgeDiagnosticsAdapter::OnTestTimeout(UINT nMsg, WPARAM wParam, LPARAM lParam, _Inout_ BOOL& /*bHandled*/)
{
	m_webSocketHander->OnMessageFromIE(/*message=*/"testTimeout", nullptr);
	return 0;
}

LRESULT EdgeDiagnosticsAdapter::OnTestStart(UINT nMsg, WPARAM wParam, LPARAM lParam, _Inout_ BOOL& /*bHandled*/)
{
