...
public:
    ...
    BEGIN_MSG_MAP(WebSocketClientHost)
        ...
        MESSAGE_HANDLER(WM_PROCESSCOPYDATA, OnMessageFromWebSocket)
    ...
    LRESULT OnMessageFromWebSocket(UINT nMsg, WPARAM wParam, LPARAM lParam, _Inout_ BOOL& /*bHandled*/);
...
private:
    ...
    HRESULT SendMessageToWebSocket(_In_ CString& message);
